...
namespace TaskExecutionSystem.DAL.Migrations
{
    ...
    [Migration("20200428231753_Task_Solution")]
    partial class Task_Solution
    {
            ...
            modelBuilder.Entity("TaskExecutionSystem.DAL.Entities.Task.Solution", b =>
                {
                    ...
                    b.HasOne("TaskExecutionSystem.DAL.Entities.Studies.Subject", null)
                        .WithMany("Solutions")
                        .HasForeignKey("SubjectId");
